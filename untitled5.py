...
def main():
    ...
    details_df = pd.read_csv('DATASET/IMON/IMON 03-12-2024.csv', encoding='ISO-8859-1', delimiter=';', on_bad_lines='skip')
    ...
    file_path = "DATASET/ALERTE/IMON/Alerte IMON 03-12.xlsx"
