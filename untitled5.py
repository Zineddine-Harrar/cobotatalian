...
def main():
    ...
    details_df = pd.read_csv('DATASET/IMON/12-11-2024.csv', encoding='ISO-8859-1', delimiter=';', on_bad_lines='skip')
    ...
    file_path = "DATASET/ALERTE/IMON/Alerte IMON 12-11.xlsx"
