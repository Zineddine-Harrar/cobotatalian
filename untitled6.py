...
def main():
    ...
    details_df = pd.read_csv('DATASET/T2F/RQUARTZ_12-11-2024.csv', encoding='ISO-8859-1', delimiter=';', on_bad_lines='skip')
...
# Convertir les colonnes pertinentes en format numérique
    ...
    file_path = "DATASET/ALERTE/T2F/Alerte T2F-12-11-2024.xlsx"
